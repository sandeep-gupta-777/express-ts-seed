...
export const apiControllers : {api:string, verb:string, controller:IController}[] = [
    ...
    {api:'/read/note/:_id', verb:'post', controller:readNote},
